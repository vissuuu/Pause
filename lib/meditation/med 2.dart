                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          onTap: (){
                            // Navigator.pop(context);
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => const medi_music2(),));
                          },
                    ...
                    child: Row(
                      ...
                      children: [
                        InkWell(
                          onTap: (){
                            // Navigator.pop(context);
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => const medi_music3(),));
                          }
                          ,child:
                          Container(
                            width: 135,
                        ...
                        InkWell(
                          onTap: (){
                            // Navigator.pop(context);
                            // Navigator.push(context, MaterialPageRoute(builder: (context) => const medi_music4(),));
                          },
                          child: Container(
                            width: 135,
                            height: 165 ,
